      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="block md:hidden text-base">
          ...
          <div
            ...
            style={{
              opacity: Math.min(1, Math.max(0, 1 - (scrollOpacity - 0.98) * 20)),
            }}
          >
            <div className="space-y-4">
              <p className="text-gray-300 italic">
                The <span style={{ letterSpacing: '0.05em' }}>Colosseum</span>, a grand
                architectural feat of the Roman Empire, was emblematic of the &ldquo;bread and
                circuses&rdquo; strategy—an elaborate spectacle designed to pacify and distract the
                masses through displays of violence and death. It served as a political tool,
                offering brutal entertainment to maintain control over an oppressed population.
              </p>
              <p className="text-gray-300 italic">
                In contrast, &ldquo;<span style={{ letterSpacing: '0.1em' }}>Cogainium</span>&rdquo;
                represents a radically different philosophy: the use of entertainment not as a means
          ...
          <div
            ...
            style={{
              opacity: Math.min(
                1,
                Math.max(0, (scrollOpacity - 0.99) * 20 - (scrollOpacity - 1.98) * 20)
              ),
            }}
          >
            <div className="space-y-4">
