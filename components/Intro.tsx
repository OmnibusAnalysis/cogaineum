    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        <div className="space-y-6 text-lg">
          ...
          <p className="text-gray-300 italic">
             Cogainium celebrates the absurdity and vibrancy of life itself. It thrives on face-to-face interaction, 
             transforming performance into a competitive, yet collaborative, sport of art—one that invites participation, 
             fosters creativity, and reclaims entertainment as a shared human experience rather than a spectacle of suffering.
          </p>
        </div>
      </div>
    </div>
